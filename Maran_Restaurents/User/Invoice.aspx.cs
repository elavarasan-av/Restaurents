...
namespace Maran_Restaurents.User
{
    public partial class Invoice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Session["UserId"] != null)
                {
                    ...
                    {
                        rep_OrderItem.DataSource = GetOrderDetails();
                        rep_OrderItem.DataBind();
                    }
                }
                else
                {
        ...
        protected void lkbtn_DownlodInvoice_Click(object sender, EventArgs e)
        {
            try
            {
            ...
            {
                lbl_MsgInvoice.Visible = true;
                lbl_MsgInvoice.Text = "Error Message:- " + ex.Message.ToString();
            }
        }
        ...
        private void ExportToPdf(DataTable dtblTable, String strPdfPath, String strHeader)
        {
            ...
            prgAuthor.Add(new Chunk("Order From : Friends Fast Food", fntAuthor));
